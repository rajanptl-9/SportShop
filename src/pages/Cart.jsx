...
const Cart = () => {
  ...
  return (
    <div className="border-t pt-14">
      ...
      <div>
        {cartData.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:gird-cols-[4fr_2fr_0.5fr] items-center gap-4"
            >
      ...
      <div className="justify-end my-20 mflex">
            ...
            <button
              onClick={() => {
                if (token) {
                  ...
                  toast.info("You Need to Log for Proceed");
                }
              }}
